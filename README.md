...
> **Note:** These are public toy demos only. Full specifications and implementations remain private to safeguard potential patents.

---

## 🛡️ IP Protection & Licensing

This repository is protected by the **[Solaris Framework](https://github.com/phibronotchi-beep/solaris-framework)** - a revolutionary IP protection system for independent inventors.
...
📄 **[THE SOLARIS PROJECT](SOLARIS_PROJECT.md)** - Full manifesto, licensing terms, derivative technologies, collaboration framework

📧 **Licensing Inquiries:** phibronotchi@gmail.com  
🌐 **Solaris Framework:** [github.com/phibronotchi-beep/solaris-framework](https://github.com/phibronotchi-beep/solaris-framework)
...
python examples/[demo].py  # Run a sample demo
```
...
* [The Solaris Project - Full Details](SOLARIS_PROJECT.md)
...
├── SOLARIS_PROJECT.md (complete framework & philosophy)
├── LICENSE
│
├── PNM-public/
│   ├── README.md
...
```
Sproule, D. E. (2026). Biomimetic Inventions: Phyllotactic Neural Meshing,
Golden-Angle Fractal Antenna Arrays, and PhiKey Cryptography.
...
- Inventions & Concepts: Solaris Framework (see [SOLARIS_PROJECT.md](SOLARIS_PROJECT.md))

**Summary:**
- 🆓 Free for research, education, personal use
- 💰 Commercial use requires licensing
- 📄 Full terms in [SOLARIS_PROJECT.md](SOLARIS_PROJECT.md)
